...
Label(header, text="STUDENT INFORMATION SYSTEM", font = 'Helvitica 20 bold', bg="#e38307", fg="blue").place(relx=.5, rely=.4, anchor='c')
Label(header, text="a simple demonstration", font = 'Helvitica 12 italic', bg="#e38307", fg="blue").place(relx=.5, rely=.65, anchor='c')

#Code for a dynamic searchbar
searchFrame = Frame(root)
searchFrame.grid(row=1,column=0,pady=3)
Label(searchFrame, bg="#fbc681", text="SEARCH:", anchor=W, font = 'Arial 9 bold', fg="blue").grid(row=0, column=0)
